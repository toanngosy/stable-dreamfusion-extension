...
dreamfusion_skip_install = os.environ.get('DREAMFUSION_SKIP_INSTALL', False)
if not dreamfusion_skip_install:
    name = "Dreamfusion"
    req_file = os.path.join(os.path.dirname(os.path.realpath(__file__)), "requirements.txt")
    print(f"Installing requirements for Dreamfusion")
...
print(f"Dreafusion revision is {revision}")
