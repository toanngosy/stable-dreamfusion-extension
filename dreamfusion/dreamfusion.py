...
def start_training(model_dir,
    ...
    radius_range = convert_str_to_float_list(radius_range)
    fovy_range = convert_str_to_float_list(fovy_range)
    print('here')
    print('model_dir: ', model_dir) 
    print('pretrained_vae_name_or_path:', pretrained_vae_name_or_path)
    ...
    print('radius_range: {} {}'.format(radius_range, type(radius_range)))
    print('fovy_range: {} {}'.format(fovy_range, type(radius_range)))
    ...
    print('lambda_orient: ', lambda_orient)
...
def convert_str_to_float_list(s):
    return [float(v) for v in s[1:-1].split(',')]